...
.detailinfo #status{border-bottom:0.5px solid #e6e6e6;}
...
.actionbtns .actionbtn{display:inline-block;height:1rem;width:46%;;line-height:1rem;text-align:center;font-size:16px;border:0.5px solid #509fff;border-radius:4px;color:#509fff;}
