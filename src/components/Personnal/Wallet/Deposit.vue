    ...
    <div id="coinoperation">
        <div class="header_pl">
            <div class="headerline clearfloat" style="text-align:center;">
                <img id="puttycancel" src="https://s.lendx.vip/static/test/images/icon/pic_navb.png" @touchend="goBack" alt="return"> 
                <p>{{$t('充值')}}</p>
            </div>     
        </div>
            ...
            <div class="address">
                ...
                <div class="address-sub2">
                    ...
                    <div class="Depositbox">
                        ...
                        <span  ref="copyadd1" data-clipboard-action="copy"  data-clipboard-target="#addressDeposit" @touchend="copyOrPasteTxt(1)">{{$t('复制btn')}}</span> 
                    </div>
                </div>
                <div class="address-sub2" style="border-top: 0.5px solid #e6e6e6;padding-top:.2rem;" v-if="queryObj.opercoincode=='GXS' ||queryObj.opercoincode=='LV'">
                    <p >Memo</p>
                    <div class="Depositbox">
                        <div id="memo" class="Depositbox-address" v-html="queryObj.memo"></div>
                         <span  ref="copyadd2" data-clipboard-action="copy"  data-clipboard-target="#memo" @touchend="copyOrPasteTxt(2)">{{$t('复制btn')}}</span> 
                    </div>
                </div>
        ...
        <div class="tips">
            ...
            <p>{{$t('deposittip.tip1',{name:queryObj.opercoincode})}}</p>
            <p>{{$t('deposittip.tip2',{sure:queryObj.sure,can:queryObj.can})}}</p>
            <p>{{$t('deposittip.tip3',{minr:queryObj.minr,name:queryObj.opercoincode})}}</p>
