<template>
    <div id="gift">
        ...
        <img id="headbanner" src="https://s.lendx.vip/static/test/images/personnal/module7/headbanner.png" alt="">        
    ...
    mounted(){
         this.$axios.get("/trade/inviter/info").then( result1 => {
                          switch (Number(result1.code)) {
                              case 2000: 
                                this.inviterurl="https://mobile.lendx.vip?code="+result1.data.code;
                                this.invitercode=result1.data.code;
                                this.inviteramount=result1.data.amount;
                                this.inviternumber=result1.data.number;
                                this.qrcode('https://mobile.lendx.vip?code='+this.invitercode);
                              break;
                              default:
...
.headerline{height:1.17rem;line-height:1.17rem;font-size:16px;background-color:#fff;    border-bottom: 0.5px solid #e6e6e6;}
...
.recommandsquire .squireimg{position: absolute;width: 90%; margin-top: -10px;line-height:1rem;text-align:center;height:1.17rem;color:#fff;background: url('https://s.lendx.vip/static/test/images/personnal/module7/squire0.png') no-repeat;background-size: 4.5rem 1.17rem;background-position: center 0;}
...
.haf_pipes input{width:90px;border:0.5px solid #509fff; height: 30px;line-height: 30px;text-align: center;}
.haf_pipes span,.investlink  span{ display: inline-block;padding-left:12px;border: 0.5px solid #509fff;font-size:16px; height: 30px;line-height: 30px;}
...
.investlink input{width:80%;border: 0.5px solid #509fff; height: 30px;line-height: 30px;}
.myrecommandlist{padding-bottom:.4rem ;}
.myrecommandlist .squireimg{background-image: url('https://s.lendx.vip/static/test/images/personnal/module7/squire1.png');text-align: center;}
.myrecommandlist .pipes{padding:1.17rem 0 0 0;font-size:14px;}
.myrecommandlist .haf_pipes span{border:0;line-height:inherit;color:#595959;text-align:center;background: url('https://s.lendx.vip/static/test/images/personnal/module7/squire1_frendicon.png') no-repeat center;background-size:contain;}
.myrecommandlist .haf_pipes span i{color:#FF7956}
.myrecommandlist .haf_pipes:nth-child(2) span{background-image: url('https://s.lendx.vip/static/test/images/personnal/module7/squire1_goldicon.png')}
