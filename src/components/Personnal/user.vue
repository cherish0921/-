    ...
    <div id="user">
        <div class="header_pl">
            <div class="headerline">
                <img src="https://s.lendx.vip/static/test/images/icon/pic_nav.png" @touchend="cancelalert" alt="返回"> 
                <p>个人中心</p>
            </div>  
        ...
        <div class="common" v-if="blockchain != 1">
            ...
            <div class="clearfloat" v-if="!phone"><span>手机号</span><span @touchend="goToSet(1)">去设置</span><img src="https://s.lendx.vip/static/test/images/icon/arrow.png" alt="" srcset=""></div>
            <div class="clearfloat" v-if="nickname"><span>昵称</span><span>{{nickname}}</span></div>
            <div class="clearfloat" v-if="!nickname"><span>昵称</span><span @touchend="goToSet(2)">去设置</span><img src="https://s.lendx.vip/static/test/images/icon/arrow.png" alt="" srcset=""></div>
        </div>
...
#user .common>div{height:1.33rem;line-height: 1.33rem;background-color:#fff;border-bottom:0.5px solid #e5e5e5;padding-right:.4rem;}
...
#user .nocountbtn{margin:.75rem 2rem;height:1.17rem;line-height:1.17rem;border:0.5px solid #509fff;color:#509fff;font-size:16px;}
</style>
