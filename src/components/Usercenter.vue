<template>
<div id="usercenter">
    <img src="https://s.lendx.vip/static/test/images/icon/pic_nav.png" @touchend="cancelalert" alt="">
    ...
    <div class="inputs">
        <div>
            <img src="https://s.lendx.vip/static/test/images/personnal/module1/cart2.png" alt="邮箱">
            <input type="text" v-model="mail" placeholder="请输入邮箱">
        </div>
        <div v-if="act!='login'">
            <img src="https://s.lendx.vip/static/test/images/personnal/module1/cart3.png" alt="验证码">
        ...
        <div>
            <img src="https://s.lendx.vip/static/test/images/personnal/module1/cart1.png" alt="密码">
            ...
            <div class="tip-box"  v-show="tipState">
                ...
                <img  src="https://s.lendx.vip/static/test/images/personnal/module1/tip.png"  style="opacity: 0;" alt="">
            </div>
            <img id="taparea" @touchend="toShowTip" src="https://s.lendx.vip/static/test/images/personnal/module1/tip.png" alt="">
        </div>
        <div v-if="act=='regist'">
            <img src="https://s.lendx.vip/static/test/images/personnal/module1/cart4.png" alt="邀请码">
        ...
        confirm() {
            ...
            if (!this.LEND.checkMail(this.$data.mail)) {
                ...
                if (this.LEND.checkPass(this.$data.pwd) < 3) {
                    this.$toast(this.$t('密码格式错误')+','+this.$t('密码提示'));
                    return;
                }
            }
            if (this.act == 'regist') {
